...
<form id="report_form" action="index.php?action=upload_report" method="post" class="my-4" enctype="multipart/form-data">
    <fieldset class="border p-3">
...
<script src="public/scripts/upload/files_utils.js" type="module"></script>
<script src="public/scripts/upload/upload_application.js" type="module"></script>
<script src="public/scripts/upload/upload_report.js" type="module"></script>
<script src="public/scripts/upload/upload_presentation.js" type="module"></script>
